...
export const NotificationPreferencesSchema = z.object({
  userId: z.string().min(1),
  shoot_reminder_1h: ChannelPreferenceSchema.default({ push: true, email: false, in_app: true }),
  shoot_reminder_24h: ChannelPreferenceSchema.default({ push: true, email: true, in_app: true }),
  deadline_reminder: ChannelPreferenceSchema.default({ push: true, email: true, in_app: true }),
  status_change: ChannelPreferenceSchema.default({ push: false, email: false, in_app: true }),
  project_assigned: ChannelPreferenceSchema.default({ push: true, email: true, in_app: true }),
  overdue_alert: ChannelPreferenceSchema.default({ push: true, email: true, in_app: true }),
  payment_received: ChannelPreferenceSchema.default({ push: true, email: false, in_app: true }),
